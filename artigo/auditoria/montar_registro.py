...
AFIRMACOES = [
    ...
    ("C06", "1 Introdução", "Em 2021, o Espírito Santo criou", "iniciativa inédita no estado.", [CA], [], []),
    ("C07", "1 Introdução", "A Lei estadual nº 11.246/2021 incluiu", "(ESPÍRITO SANTO, 2021a).", [CA], ["esp2021a"], []),
    ("C08", "1 Introdução", "A Lei de Incentivo à Cultura Capixaba, como", "nos cinco ciclos.", [Q, T], ["esp2021b", "secult2026b"], [NU]),
    ("C09", "1 Introdução", "Em 2025, 63 projetos captaram", "o teto do ano.", [Q], ["secult2026b"], [NU]),
    ("C10", "1 Introdução", "O setor cultural capixaba é pequeno", "(IBGE, 2023).", [Q], ["ibge2023"], [NU]),
    ...
    ("C14", "1 Introdução", "Terceiro, a política é nova", "nenhum estudo sobre ela.", [CA], [], [DI]),
    ...
    ("C17", "2 Caracterização", "A segunda é a **instabilidade**", "alterou o fluxo de habilitação no meio de 2025.", [CA, T], [], []),
    ("C18", "2 Caracterização", "Até maio de 2025, o parecer", "saía à procura de patrocinador.", [CA], ["secult2025a"], [MC]),
    ("C18b", "2 Caracterização", "Desde então, o projeto só chega", "carta de intenção de patrocínio (SECULT, 2025b).", [CA], ["secult2025b"], [MC]),
    ...
    ("C24", "3 Revisão", "O Tribunal de Contas da União recomendou", "sem incentivo (BRASIL, 2016).", [CA], ["tcu2014", "tcu2016"], [MC]),
    ...
    ("C27", "3 Revisão", "Não localizamos avaliação causal", "via ICMS.", [CA], [], [DI]),
    ...
    ("C29", "3 Revisão", "Grandes eventos culturais têm", "MONGARDINI, 2020).", [CAU], ["gomes2018", "bronzini2020"], [CS]),
    ...
    ("C32", "4.2 Avaliação", "O decreto declara um objetivo de produto", "(ESPÍRITO SANTO, 2021b, art. 3º).", [CA], ["esp2021b"], [HC]),
    ("C33", "4.2 Avaliação", "Não há meta, magnitude esperada", "(BRASIL, 2014).", [CA], ["barros2017", "tcu2014"], [HC]),
    ("C34", "4.2 Avaliação", "O valor autorizado de cada ciclo foi", "esgotou o teto ao centavo.", [Q], ["secult2026b"], [NU, HC]),
    ...
    ("C38", "4.2 Avaliação", "Segundo, a carteira se renova pouco", "ficam com 47% do valor.", [Q], ["secult2026b"], [NU, HC]),
    ...
    ("C44", "4.2 Avaliação", "O padrão é o inverso do gasto municipal", "em 2025.", [Q], [], [NU]),
    ("C45", "4.2 Avaliação", "A maior reserva do teto, 30%", "não descumprimento apurado.", [CA], ["secult2025a", "tcu2016"], [DI]),
    ("C46", "4.2 Avaliação", "O que a SECULT publica cobre", "se as cotas foram cumpridas.", [CA], ["secult2026b"], [MC]),
    ("C47", "5.2 Identificação", "A regressão descontínua não se aplica", "pelos próprios interessados.", [CA], ["secult2025a"], [MC]),
    ("C48", "5.2 Identificação", "A janela se restringe a 2022-2024", "quase se confundem.", [CA], ["secult2025b"], [MC]),
    ...
    ("C56", "5.4 Poder", "em que $n$ = 293 projetos", "dispersão do tamanho das carteiras).", [Q], [], [NU, MC]),
    ("C57", "5.4 Poder", "O universo disponível detecta, portanto", "que a literatura trata como moderados.", [Q], [], [NU, HC]),
    ...
    ("C61", "6 Conclusão", "As reservas do art. 18 atuam", "com o que se publica.", [CA], ["secult2025a"], [HC]),
    ...
    ("C71", "4.2 Avaliação", "| Patrocinadores (2025) | Empresas;", "| 26; 44% |", [Q], ["secult2026b"], [NU]),
    ...
    ("C74", "4.2 Avaliação", "Fonte: elaboração própria com base em SECULT (2026b), portarias", "SICONFI.", [O], ["secult2026b"], []),
