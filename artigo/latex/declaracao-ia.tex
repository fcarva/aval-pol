...
\vspace{6pt}
{[}Adequar ao modelo anexo às instruções da disciplina.{]} O autor utilizou ferramenta de
...
revisado pelo autor, que assume integral responsabilidade pelos dados, análises e conclusões.
